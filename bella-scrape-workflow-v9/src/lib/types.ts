...
export interface WorkflowResults {
  ...
  step_workers_ai_5?: { response: any; text: string; usage: any };
  step_kv_put_6?: { success: boolean; key: string };
  step_early_stages?: { success: boolean; key: string; count: number };
  step_wait_event_7?: { event: null; timedOut: true };
  step_kv_get_8?: { value: string | null; exists: boolean; metadata: any };
  step_workers_ai_9?: { text: string; usage: any };
  step_transform_10?: { text: string; raw: string; gemini_status: string };
  step_kv_put_11?: { success: boolean; key: string };
  ...
  step_workers_ai_16?: { response: any; text: string; usage: any };
  step_transform_17?: { json: string };
  step_kv_put_18?: { success: boolean; key: string };
  step_kv_put_script_stages?: { success: boolean; key: string; count: number };
