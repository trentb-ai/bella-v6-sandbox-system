...
- Do not reuse any 3-word sequence across the following fields: positioning.summary, icpAnalysis.icpProblems, icpAnalysis.icpSolutions, conversionEventAnalysis.conversionNarrative, and trainingBridge.line. Each field must add genuinely new information — never rephrase another field.
- Optimise every output field for spoken delivery. Every sentence must be under 20 words. No marketing fluff. Assume another model will speak these aloud on a live voice call.
...
{
  "positioning": {
    "summary": "1-2 sentences: market category + who they are for + main differentiator. Use THEIR language from the copy. No tagline copy-paste — paraphrase with distinct words. Spoken-ready, under 20 words per sentence.",
    ...
    "secondaryCTAs": [
      {
        ...
        "label": "Exact button text, link text or CTA label from the page",
        "assetTitle": "Name of the asset if applicable — e.g. 'Free Strategy Session', 'New Patient Info Pack', 'Ultimate Buyers Guide'. Empty string if no asset title.",
  ...
  "trainingBridge": {
    "line": "REQUIRED — 1-2 sentences that explicitly tie together: who they serve + the problems they bring + how they solve them + the exact CTAs on their site — framed as what the AI agents are being trained on. Bella says this verbatim. Example: 'Everything I have just described — who you serve, the problems they bring, how you solve them, and the specific calls to action — is what your demo agent team has already been trained on in the background.' Must be spoken-friendly, under 20 words per sentence."
  }
}
...
11. positioning.summary — 1-2 sentence market positioning statement
12. trainingBridge.line — 1-2 sentence agent training bridge
13. conversionEventAnalysis.secondaryCTAs — array of all non-primary CTAs with label, channel, assetTitle, location
...
GROUP D (Training bridge):
- positioning.summary
- trainingBridge.line
- icpAnalysis.marketPositionNarrative
Rule: positioning.summary states the market category and differentiator. trainingBridge.line explicitly connects the full picture to agent training. marketPositionNarrative explains how they position vs competitors. Three different angles — no overlap.
